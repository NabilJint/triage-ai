    ...
    >
      <div className="max-w-1280px mx-auto px-6 h-full">
        <nav className="flex items-center justify-between h-full" aria-label="Main navigation">
          <Link href="/" className="text-primary text-xl font-bold tracking-tight" aria-label="TriageAI home">
            TriageAI
          </Link>
          ...
          <Sheet>
            <SheetTrigger asChild>
              <button className="md:hidden p-2 -ml-2 rounded-md text-text-dark hover:bg-surface-secondary transition-colors" aria-label="Open menu">
                <Menu className="size-6" />
              </button>
            </SheetTrigger>
            <SheetContent side="right" className="w-72 p-6" showCloseButton={false}>
              <div className="flex justify-end mb-6">
                <SheetClose className="p-2 -mr-2 -mt-2 rounded-md text-text-dark hover:bg-surface-secondary transition-colors cursor-pointer" aria-label="Close menu">
                  <X className="size-6" />
                </SheetClose>
              </div>
