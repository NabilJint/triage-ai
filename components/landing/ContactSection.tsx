    ...
    <section id="contact" className="bg-bg-primary py-16 md:py-24 scroll-mt-16">
      <div className="max-w-1280px mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-lg font-semibold text-text-primary mb-2">Get in Touch</h2>
          <p className="text-sm text-text-secondary">Have questions? We&apos;d love to hear from you.</p>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 text-left">
            <div className="flex flex-col items-center text-center p-6 bg-surface border border-border rounded-lg">
              ...
              <p className="mt-2 text-sm text-text-secondary">support@triageai.com</p>
              <Link
            ...
            <div className="flex flex-col items-center text-center p-6 bg-surface border border-border rounded-lg">
              ...
              <p className="mt-2 text-sm text-text-secondary">Available 9am–5pm PST</p>
              <Link
                href="/login"
                className="mt-4 text-sm text-primary hover:underline"
              >
            ...
            <div className="flex flex-col items-center text-center p-6 bg-surface border border-border rounded-lg">
              <Github className="text-primary size-8 mb-3" />
              <h3 className="font-semibold text-text-primary">GitHub</h3>
              <p className="mt-2 text-sm text-text-secondary">Report issues or contribute</p>
              <Link
